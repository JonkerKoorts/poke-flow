          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {pokemonData.map((pokemon: any) => (
              <div
                ...
                className="border border-white/10 rounded-xl p-4 bg-white/5 hover:bg-white/10 transition-all duration-300 cursor-pointer hover:shadow-[0_0_30px_rgba(255,0,0,0.2)]"
              >
                <img
                  src={pokemon.sprite}
                  alt={pokemon.name}
            ...
            <div key={role} className="border-b border-white/10 pb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {pokemons.map((pokemon: any) => (
                  <div
                    key={pokemon.name}
                    className="border border-white/10 rounded-xl p-4 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,0,0,0.2)]"
                  >
                    <img
                      src={pokemon.sprite}
                      alt={pokemon.name}
